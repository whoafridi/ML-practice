...
Label(root,text ="Project Translate", font = 'arial 20 bold', bg ='white smoke' , width = '20').pack(side = 'bottom')
...
Output_text = Text(root,font = 'arial 10', height = 14, wrap = WORD, padx=5, pady= 5, width =60)
